...
function calc() {
  ...
  const y = convert(x);
  document.mrsancalcform.y.value = roundResult(y);
}
...
function calctest() {
  const x = document.mrsancalcform.x.value;
  const y = convert(x);
  document.mrsancalcform.y.value = roundResult1(y);
}
...
function calc5() {
  ...
  const y1 = convert1(x);
  document.mrsancalcform.y1.value = roundResult(y1);

  const y2 = convert2(x);
  document.mrsancalcform.y2.value = roundResult(y2);
}
