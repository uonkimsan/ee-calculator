...
function calc3() {
	y = roundresult(y = convert(x1 = document.calcform.x1.value, x2 = document.calcform.x2.value)),
		document.calcform.y.value = y
}

function calc4() {
	x1 = document.calcform.x1.value, y = roundresult(y = convert(x1, x2 = document.calcform.x2.value, x3 = document.calcform.x3.value)),
		document.calcform.y.value = y
}
...
function num2str(e, r) { //!!!if( arguments.length==1 ) if (void 0===r) var r=-1; if (-1 !=(e=e.toString()).indexOf("e")) { var t=1.1.toLocaleString().substring(1, 2); return e=e.replace(".", t) } e=Number(e=(e=e.replace("âˆ’", "-" )).substring(e.indexOf("-"))); var n=r < 0 ? 0 : r, u=r < 0 ? 20 : r; return e=(e=e.toLocaleString(void 0, { minimumFractionDigits: n, maximumFractionDigits: u })).trim().replace(/\u00D7/g, "" ) } function num2str2(e) { var r=1.1.toLocaleString().substring(1, 2), t=1e3.toLocaleString().substring(1, 2); if (-1 !=(e=e.toString().replace(".", r)).indexOf("e")) return e; var n=e.indexOf(r); if (-1==n && (n=e.length), n> 3)
...
function GetOS() {
	var e = "unknown";
	return -1 != navigator.userAgent.indexOf("Android") && (e = "Android"), -1 != navigator.userAgent.indexOf("like Mac") && (e = "iOS"),
		e
}
